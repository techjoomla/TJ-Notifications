...
class ProcessNotifications extends JApplicationCli
{
	...
	public function execute()
	{
		...
		$data->context			= 'com_tjreports';
		$data->context_id		= 'test123';
		$data->body				= 'This is the body of the notification content.';
		$data->subject			= 'Here is the subject of my notification';
		$data->recipient		= 'amol_p12452@mailinator.com';
		$data->created			= '0000-00-00 00:00:00';
		$data->expiry			= '0000-00-00 00:00:00';
		$data->retries			= '0';
		$data->last_attempted	= '0000-00-00 00:00:00';
		$data->status			= '0';
		$data->options			= '';
		$result					=	$db->insertObject('#__tj_notification_queue', $data, 'queue_id');
		die('Amol hhereee!!!'); */
